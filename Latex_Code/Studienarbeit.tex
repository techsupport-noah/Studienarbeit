...
(Reihenfolge basiert auf Reihenfolge die in Aufgabenstellung erwähnt wurde.)
    ...
    \section{Theorie}
        ...
        Im Bereich professioneller Anwendung wird ARDUINO zum Beispiel für Prototyping und Rapid-Iteration verwendet.%belegen! why arduino
